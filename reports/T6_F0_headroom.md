...
Generated by `python3 src/t6_f0_headroom.py` on 2026-09-21. Deterministic, no seed. Spec `v3.1`. No language model was run: this reads P1's frozen `cond4` outputs.
